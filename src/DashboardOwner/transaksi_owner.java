...
import DashboardAdmin.transaksi;
import Auth.login;
...
public class transaksi_owner extends javax.swing.JFrame {
 private PreparedStatement stat;
 private ResultSet rs;
 private DefaultTableModel model = null;
 koneksi k = new koneksi();
  
    public transaksi_owner() {
        Icon();
        initComponents();
        k.connect();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(transaksi_owner.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new transaksi_owner().setVisible(true);
            }
        });
    }
